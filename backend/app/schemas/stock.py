...
class StockMovementCreate(BaseModel):
    ...
    quantity: int = Field(..., description="Entrada/saida usam valor positivo; ajuste aceita positivo ou negativo.")
    ...
    def validate_quantity(self) -> "StockMovementCreate":
        ...
        if self.type in {StockMovementType.ENTRADA, StockMovementType.SAIDA} and self.quantity < 0:
            raise ValueError("Entrada e saida de estoque devem ter quantidade positiva.")
